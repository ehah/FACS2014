theory model
imports "~/workspace/tools/s2h/HHLProver/HHL"
begin
...
"inv == t[>=](Real 0) [&] t[<=]T [&] (v[=](Real 1) [&] (h[>=](Real 0.30) [&] h[<=](Real 0.59)[+](Real 0.003)[*]t) [|] (v[=](Real 0) [&] h[<=](Real 0.60) [&] h[>=](Real 0.31) [-] (Real 0.007)[*]t))"
...
"invX == x[=]h [&] t[>=](Real 0) [&] t[<=]T [&] (v[=](Real 1) [&] (x[>=](Real 0.30) [&] x[<=](Real 0.59)[+](Real 0.003)[*]t) [|] (v[=](Real 0) [&] x[<=](Real 0.60) [&] x[>=](Real 0.31) [-] (Real 0.007)[*]t)) [&] conProp"
definition invXY :: fform where
"invXY == x[=]h [&] t[>=](Real 0) [&] t[<=]T [&] (v[=](Real 1) [&] (x[>=](Real 0.30) [&] x[<=](Real 0.59)[+](Real 0.003)[*]t) [|] (v[=](Real 0) [&] x[<=](Real 0.60) [&] x[>=](Real 0.31) [-] (Real 0.007)[*]t)) [&] ((y[=](Real 1) [|] x[>](Real 0.31))) [&] conProp"
